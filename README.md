...
2. MediaPipeの **Pose Landmarker Lite** と専用 **Hand Landmarker（片手21点）** のtaskファイルが、それぞれ `python-tracker/models/pose_landmarker_lite.task` と `python-tracker/models/hand_landmarker.task` にあることを確認します。
