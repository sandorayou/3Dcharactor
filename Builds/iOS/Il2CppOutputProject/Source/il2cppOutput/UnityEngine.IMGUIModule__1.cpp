...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D SliderHandler_ThumbSelectionRect_m182932776473DDB8076E858AC0580E931AE66EB8 (SliderHandler_tA79D905C9C3D505A2257D02EC54396A74F83AA83* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		...
		int32_t L_2 = V_1;
		V_2 = (bool)((((float)L_1) < ((float)((float)L_2)))? 1 : 0);
		bool L_3 = V_2;
		if (!L_3)
		{
			goto IL_0045;
	...
	}
	{
		...
		Rect_set_x_mAB91AB71898A20762BC66FD0723C4C739C4C3406_inline(L_4, ((float)il2cpp_codegen_subtract(L_5, ((float)(((float)il2cpp_codegen_subtract(((float)L_6), L_7))/(2.0f))))), NULL);
		int32_t L_8 = V_1;
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A_inline((&V_0), ((float)L_8), NULL);
	}
...
IL_0045:
	{
		...
		int32_t L_10 = V_1;
		V_3 = (bool)((((float)L_9) < ((float)((float)L_10)))? 1 : 0);
		bool L_11 = V_3;
		if (!L_11)
		{
			goto IL_007f;
	...
	}
	{
		...
		Rect_set_y_mDE91F4B98A6E8623EFB1250FF6526D5DB5855629_inline(L_12, ((float)il2cpp_codegen_subtract(L_13, ((float)(((float)il2cpp_codegen_subtract(((float)L_14), L_15))/(2.0f))))), NULL);
		int32_t L_16 = V_1;
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03_inline((&V_0), ((float)L_16), NULL);
	}
...
IL_0084:
	{
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_18 = V_4;
		return L_18;
	}
}
